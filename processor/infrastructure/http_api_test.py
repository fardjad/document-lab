...
class HttpApiIntegrationTests(unittest.TestCase):
    ...
    def test_auto_straighten_and_trim_suggestions(self) -> None:
        ...
        self.client.post("/api/projects/scan/views", json={"name": "Card"})
        straighten = self.client.post("/api/projects/scan/views/1/auto/straighten")
        self.assertEqual(200, straighten.status_code)
        self.assertIsInstance(straighten.json()["suggestion"], float)
        trim = self.client.post("/api/projects/scan/views/1/auto/trim")
        ...
        self.assertEqual(404, self.client.post("/api/projects/scan/views/9/auto/trim").status_code)
